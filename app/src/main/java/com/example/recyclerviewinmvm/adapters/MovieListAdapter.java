package com.example.recyclerviewinmvm.adapters;
...
import com.example.recyclerviewinmvm.R;
...
public class MovieListAdapter extends RecyclerView.Adapter<MovieListAdapter.myviewholder>
{
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        Glide.with(holder.title.getContext()).load(movielist.get(position).getImage()).into(holder.img);
    }
